    ...
    return (
        ...
        >
            <label className='flex flex-col items-start'>
                ...
                <div className='w-[100%] bg-white rounded-[45px] flex transition-all items-center justify-between p-[14px] shadow h-[100%]'
                    ref={inputRef}
                >
                    <input
                        onFocus={handleInputFocus}
                        className={clsx('outline-none w-[80%]', inputClassName)}
                        type={type}
                        onChange={onChange}
                        placeholder={placeholder}
                        value={value}
                    />
                    <div className='w-[15%] relative cursor-pointer'>
                        {
                            imgSrc ? <img
